...
def detail_solucion(request, codigo_solucion):
    ...
    try:
        ...
        if not solucion_response:
            return render(request, 'soluciones/detail_soluciones.html', {'error': 'Solución no encontrada.'})  # Cambiar la plantilla a 'detail_soluciones.html'
        ...
        return render(request, 'soluciones/detail_soluciones.html', {  # Cambiar la plantilla a 'detail_soluciones.html'
            'solucion': solucion_data,  # Cambiar 'oportunidad' por 'solucion'
